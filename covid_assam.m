...
y0 = [N/100, 0, 1, 0,0]; % Coronavirus count 
...
[t,y2]=ode45(@(t,y) ode_fun_simple(t, y, beta/7.8), tspan2, y_2nd);
...
ylabel('Population')
title('Predicted Spread of COVID-19 in Assam')
grid on;
grid minor;
set(gca, 'FontSize', 26)