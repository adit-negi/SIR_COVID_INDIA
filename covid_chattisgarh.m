...
N = 2.55e+7; % Population of  
beta = R_0/(N*Duration*0.42);
...
y0 = [N-17, 0, 1, 0,0]; % Coronavirus count 
...
[t,y2]=ode45(@(t,y) ode_fun_simple(t, y, beta/7), tspan2, y_2nd);
...
ylabel('Population')
title('Predicted Spread of COVID-19 in Chattisgarh')
grid on;
grid minor;
set(gca, 'FontSize', 26)