...
y0 = [N-17, 0, 14, 3,1]; % Coronavirus count 
...
[t,y2]=ode45(@(t,y) ode_fun_simple(t, y, beta/5.5), tspan2, y_2nd);
...
ylabel('Population')
title('Predicted Spread of COVID-19 in punjab')
grid on;
grid minor;
set(gca, 'FontSize', 26)