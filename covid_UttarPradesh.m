...
N = 20.42e+7; % Population of  
beta = R_0/(N*Duration*0.4);
...
y0 = [N-28, 0, 24, 1,0]; % Coronavirus count 
...
[t,y2]=ode45(@(t,y) ode_fun_simple(t, y, beta/5), tspan2, y_2nd);
...
ylabel('Population')
title('Predicted Spread of COVID-19 in uttar pradesh')
grid on;
grid minor;
set(gca, 'FontSize', 26)