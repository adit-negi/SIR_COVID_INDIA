...
N = 6.89e+7; % Population of  
beta = (R_0*5)/(N*Duration*0.44);
...
y0 = [N/4, 0, 19, 1,0]; % Coronavirus count 
...
[t,y2]=ode45(@(t,y) ode_fun_simple(t, y, beta/3.8), tspan2, y_2nd);
...
ylabel('Population')
title('Predicted Spread of COVID-19 in rajasthan')
grid on;
grid minor;
set(gca, 'FontSize', 26)