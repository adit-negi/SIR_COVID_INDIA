...
N = 6.27e+7; % Population of  
beta = (R_0)/(N*Duration*0.49);
...
y0 = [N, 0, 18, 1,0]; % Coronavirus count 
...
[t,y2]=ode45(@(t,y) ode_fun_simple(t, y, beta/3), tspan2, y_2nd);
...
ylabel('Population')
title('Predicted Spread of COVID-19 in gujrat')
grid on;
grid minor;
set(gca, 'FontSize', 26)