...
N = 135.42e+7; % Population of  
beta = R_0/(N*Duration*0.45);
...
y0 = [N-295, 0, 285, 10,17]; % Coronavirus count 
...
[t,y2]=ode45(@(t,y) ode_fun_simple(t, y, beta/4), tspan2, y_2nd);

y_combined = [y;y2];

%%
plot(0:1:300,y_combined/10,'LineWidth', 1.5, 'MarkerSize', 18)
